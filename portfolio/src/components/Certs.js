    ...
    return (
      <Card className={classes.card}>
        <CardHeader
          ...
          subheader="Coding BootCamp"
        />
        <CardMedia
          className={classes.media}
          image="https://www.nuin.northwestern.edu/wp-content/uploads/2020/04/SkylineNorthwestern-996x610.jpg"
          title="Northwestern"
        />
        <CardContent>
          <Typography component="p">
           Graduate of Northwestern's Coding Bootcamp
          </Typography>
          <SimpleModalWrapped 
          certificate={nw}
          />
